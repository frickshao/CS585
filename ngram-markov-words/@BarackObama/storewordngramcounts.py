...
def countngrams(frequencies, order, buffer_size=1024):
    ...
    for tweet in tweets[0]:
        ...
        for bigram in ngrams(tokens, order):
            ...
            #print(bigram, ngrams(tokens, order))
...
if __name__ == '__main__':
    ...
    print('Stored frequencies of {} encountered N‑grams. in {}'.format(len(frequencies), out))